...
module.exports = {
    ...
    async update(req, res) {
        try {
            const { nome, cpf, email, senha , dataNasc, endereco, telefone, uf, crm, especialidade, descricao, id_recep, id_medic, id_admin } = req.body;
            const erros = [];
            ...
            const dados = { nome, cpf, email, senha: senha || medico.senha , dataNasc, endereco, telefone, uf, crm, especialidade, descricao };
